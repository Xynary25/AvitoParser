...
def main(page: ft.Page):
    ...
    full_code_btn = ft.TextButton("Открытый код программы",
                                     on_click=lambda e: page.launch_url("https://github.com/Xynary25/AvitoParcer"),
                                     style=ft.ButtonStyle(color=ft.Colors.RED_300), expand=True,
                                     tooltip=FULL_CODE_BTN_HELP)
    theme_switcher = ft.TextButton("Изменить тему",
                                     on_click=lambda e: toggle_theme(),
                                     style=ft.ButtonStyle(color=ft.Colors.BLUE_300), expand=True,
                                     tooltip=THEME_SWITCHER_HELP)
    report_issue_btn = ft.TextButton("Сообщить о проблеме", on_click=lambda e: page.launch_url(
        "https://github.com/Xynary25/AvitoParcer/issues"), style=ft.ButtonStyle(color=ft.Colors.GREEN), expand=True,
    ...
    other_btn = ft.Row(
        [full_code_btn, report_issue_btn, theme_switcher],
        expand=True,
        alignment=ft.MainAxisAlignment.CENTER
    )
